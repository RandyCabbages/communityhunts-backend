...
// Delete a community tenant (row + its roles + its API key). Bean can never be deleted. Hunts
// tagged to the tenant are left in place — they simply stop resolving once the tenant is gone
// (harmless), and deleting user hunt data on a tenant removal would be surprising. Mainly for
// cleaning up tests.
