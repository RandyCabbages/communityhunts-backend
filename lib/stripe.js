...
const COMMUNITY_PLANS = new Set(['community_starter', 'community_pro']);
...
async function handleWebhookEvent(event) {
  ...
  if (type === 'customer.subscription.deleted') {
    ...
    if (sub.metadata?.type === 'community' && communityProvisionFn) {
...
module.exports = {
  ...
  createCheckoutSession, createCommunityCheckoutSession, createPortalSession,
  constructEvent, handleWebhookEvent,
  setCosmeticGrantFn, setCommunityProvisionFn,
};
