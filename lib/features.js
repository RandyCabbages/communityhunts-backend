...
const FEATURES = {
  ...
  // The Rainbet-linking Full extension. NOT a community-plan perk — there is no enterprise
  // community plan (Stripe sells only community_starter/pro), so a community path would be dead
  // config. Unlocked by ROLE (tenant VIP/mod/Discord-guild VIP — free, via reqHasFullExtension),
  // a standalone $5/mo subscription or admin grant (full_extension grant), or the top INDIVIDUAL
