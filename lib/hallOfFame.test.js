...
test('payload carries the full card shape', () => {
  ...
  assert.deepStrictEqual(out[0], {
    ...
    // A PERSONAL hunt carrying the legacy per-user huntType 'vip' is still category 'community' —
    // 'vip' is reachable only by the shared hunt key. That gap is the whole reason `category` exists.
    huntType: 'vip', category: 'community', live: false, at: '2026-07-01T00:00:00.000Z',
