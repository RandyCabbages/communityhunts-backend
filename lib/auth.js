...
function signToken(user) {
  const payload = {
    ...
    isAffiliate: !!user.isAffiliate, isDiscordVip: !!user.isDiscordVip, isDiscordMod: !!user.isDiscordMod,
    ...
    if (auth.startsWith('Bearer ')) {
      ...
      if (payload) {
        req.user = {
          ...
          isAffiliate: !!payload.isAffiliate, isDiscordVip: !!payload.isDiscordVip, isDiscordMod: !!payload.isDiscordMod
        };
